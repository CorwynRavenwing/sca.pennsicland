...
if (! $r_admin) {
	...
	execute_query("UPDATE land_blocks SET  block_name = 'N40', total_square_footage = '46631', campable_square_footage = '46631', description = 'P45: campable down 5212 per Gunther' WHERE block_name = '?05' LIMIT 1");
	execute_query("UPDATE land_blocks SET hide = '0', reseerved = '0' WHERE block_name = 'N40'");
