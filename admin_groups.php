...
if (! $r_admin) {
  ...
  $system_group = $group_rec['system_group'];

  $system_group_label = "'" . $system_group . "'"
    . " ("
    . (($system_group=='A')
        ? 'ADMIN'
        : (($system_group=='F')
  ...
  template_param("user_id_prior_string"                  , $group_rec['user_id_prev']          );
  template_param("time_registered_variable_string"       , $group_time_registered              );
  template_param("system_group_variable_string"          , $system_group_label                 );
